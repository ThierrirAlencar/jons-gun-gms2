...
#region easy access player status display
	...
	if(global.gui_component_player_status_easy_display.draw){
		...
		if(global.inventory_gun_list[global.inventory_gun_slot_selected_current] != noone){
			...
			draw_set_colour(c_white)
			scr_text_wave(_x,_y+_bar_size_y+32,6,6,string(global.inventory_gun_list[global.inventory_gun_slot_selected_current].name))
		}
		...
		var _color = global.gui_component_player_status_easy_display.hearthbar.bar_colour;
		
		draw_healthbar(_x,_y,_x+_bar_size_x,_y+_bar_size_y,_total,_color,_color,_color,0,true,false);
		//draw exp bar
		...
		_bar_size_x = 128*global.ui_config_scale
